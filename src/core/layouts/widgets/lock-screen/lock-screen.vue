...
import { LockKeyhole } from '#/core/design/icons';
import { $t, useI18n } from '#/core/locales';
import { storeToRefs, useAccessStore } from '#/core/stores';
import { useVbenForm, z } from '#/core/ui/form';
import { VbenAvatar, VbenButton } from '#/core/ui/primitives';
