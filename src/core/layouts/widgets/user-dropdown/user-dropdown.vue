...
import type { AnyFunction } from '#/core/shared/types';

import { computed, useTemplateRef, watch } from 'vue';

import { useMagicKeys, whenever } from '@vueuse/core';

import { useHoverToggle } from '#/core/composables';
import { LockKeyhole, LogOut, Settings } from '#/core/design/icons';
import { $t } from '#/core/locales';
import { preferences, usePreferences } from '#/core/preferences';
import { isWindowsOs } from '#/core/shared';
        ...
        <DropdownMenuLabel class="flex items-center p-3">
          ...
          <div class="ml-2 w-full min-w-0">
            <div
              ...
              class="mb-1 flex flex-wrap items-center text-sm font-medium text-foreground"
            >
              {{ text }}
              <slot name="tagText">
            ...
            <div class="break-all text-xs font-normal text-muted-foreground">
              {{ description }}
            </div>
          </div>
        </DropdownMenuLabel>
