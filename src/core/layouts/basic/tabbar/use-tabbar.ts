...
import type { TabDefinition } from '#/core/shared/types';
import type { IContextMenuItem } from '#/core/ui/tabs';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '#/core/composables';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '#/core/locales';
import { filterTree } from '#/core/shared';
import { getTabKey, useAccessStore, useTabbarStore } from '#/core/stores';
