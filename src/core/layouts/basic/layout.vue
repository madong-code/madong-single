...
import type { MenuRecordRaw } from '#/core/shared/types';

import { computed, onMounted, useSlots, watch } from 'vue';
import { useRoute } from 'vue-router';

import { useRefresh } from '#/core/composables';
import { $t, i18n } from '#/core/locales';
import {
  preferences,
  updatePreferences,
  usePreferences,
} from '#/core/preferences';
import { cloneDeep, mapTree } from '#/core/shared';
import {
  useAccessStore,
  useTabbarStore,
  useTimezoneStore,
...
import { VbenBackTop, VbenLogo } from '#/core/ui/primitives';
