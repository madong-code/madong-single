...
import { defaultPreferences } from '../base/config';
import { isDarkTheme } from '../base/update-css-variables';

describe('preferences', () => {
  let PreferenceManager: typeof import('../base/preferences').PreferenceManager;
  let preferenceManager: InstanceType<
    typeof import('../base/preferences').PreferenceManager
  >;
  ...
  beforeAll(async () => {
    ({ PreferenceManager } = await import('../base/preferences'));
  });
